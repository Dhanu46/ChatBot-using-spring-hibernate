  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
      	<li><a href="/FlightAssistant/registration.jsp" style="color:whitesmoke;">Customer Registration</a></li>
        <li><a href="/FlightAssistant/adminLogin.jsp" style="color:whitesmoke;"><span class="glyphicon glyphicon-log-in"></span>Admin Login</a></li>
      </ul>
    </div>
  </div>
</nav>	
<div class="container">
    <form class="form-signin" action="FlightServlet" method="post">
      ...
      <button class="btn btn-lg btn-primary btn-block" type="submit" name="param" value="login">Sign in</button>
