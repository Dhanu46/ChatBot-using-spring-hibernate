...
<div class="container-fluid text-center">    
   ...
   <!-- <div class="col-sm-2 sidenav">
    ...
    <div class="col-lg text-center"> 
	  ...
	  <% FlightDao dao = new FlightDao();
	   ArrayList<Book> blist = (ArrayList<Book>)dao.getBookings();
		if(blist.size()!=0){
		int count = 0;
		%>
	   <table id="elections">
  ...
  <tbody>
  <%for (Book bl:blist){
	Flight fl = (Flight)dao.getFlightById(String.valueOf(bl.getFlightid()));
	  count++;%>
    <tr>
...
<footer class="container-fluid text-center">
  <p>Copyrighted by Flight Assistant @ 2020</p>
</footer>
